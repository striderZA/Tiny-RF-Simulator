...
- The `package` job builds the Linux/Windows artifacts attached to a GitHub release with `CMAKE_BUILD_TYPE=Release`; Debug builds are validation-only and are never shipped.
