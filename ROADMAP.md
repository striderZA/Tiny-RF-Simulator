...
| 19 | **Plugin system** — extensible component architecture | 📋 Planned (future) | Allow users to extend simulator with custom components. Design constrained by MISSION.md: data-driven (JSON/Touchstone) or external-tool SDK only; in-app scripting VMs (Lua/Python) are out of scope forever. Revisit after library manager. |
