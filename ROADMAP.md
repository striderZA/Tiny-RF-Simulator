...
|---|---------|--------|-------|
| 1 | **Data-file component descriptions** — describe components with S-parameter / nonlinear data files; built-in utility to plot loaded data file parameters | 🔄 In Progress | Touchstone v1.0 parser + SParameterAmplifierEngine: loads real .s2p, applies freq-dependent |S21| gain via linear interpolation, noise scaled by |S21|² |
