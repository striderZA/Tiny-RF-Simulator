...
| 16 | **Component library manager** — file-based library browser with global and per-project libraries | 📋 Planned (v0.8.0) | Users organize S-param files and component configs into named collections, browse from UI, one-click insert. Global (~/.rf-sim/libraries/) and per-project (./rf-sim-libraries/) libraries. |
