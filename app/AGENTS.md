...
- `RfSimulatorApp` installs a graph-link validator: a PFB input accepts only the output pin of an `adc` component; invalid direct RF-chain links are rejected both from the canvas and during project load.
